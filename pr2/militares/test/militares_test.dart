...
void main() {
  ...
  group('GRUPO TESTS DEL MODELO', () { //  clase Militar, Oficial, Raso y Ataque
    test('Incrementar Array Militares', () { // creamos un oficial y esperamos que al inicio su array de militares tenga 0 elementos y despues de agregar uno tengo 1
...
""";
  ...
  group('GRUPO TESTS DEL CONTROLADOR', () { // clase Gestor
    test('Funcion ganador() devuelve uno de los dos equipos al terminar la partida', () {
    ...
    test('Comprobar aleatoriedad del equipo que inicia el ataque', () {
      ...
      for (int i = 0; i < numSimulaciones; i++) { // hacemos 1000 batallas
      ...
      expect(empiezaE1, closeTo(500, 30)); // Si la probabilidad es la misma al hacer 1000 simulaciones cada equipo habrá empezado sobre 500 veces
      expect(empiezaE2, closeTo(500, 30)); // le damos un margen de 30 arriba y abajo dado que puede variar un poco
    });
  ...
  group("GRUPO TESTS DE LA VISTA", () { // clase RegistroBatalla
